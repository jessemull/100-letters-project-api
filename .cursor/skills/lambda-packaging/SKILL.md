...
description: >-
  Verify webpack build, zip layout, CFN Handler paths, and Node 24 runtime alignment.
---

# Lambda packaging

1. Confirm route `template.yaml`: `Runtime: nodejs24.x`, `Handler: index.handler`.
...
4. Keep CI Node 24 aligned with runtime.
